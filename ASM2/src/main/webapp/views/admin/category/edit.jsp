...
<body>
	Cập nhật loại tin
	<form action="${pageContext.request.contextPath}/admin/categories/edit?id=${category.id}" method="post">
	<div class="row">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<label for="name">Tên loại</label> <input type="text" class="form-control" id="name" name="name" placeholder="Tên loại" value="${category.name}" />
