...
<body>
	...
	<form action="${pageContext.request.contextPath}/admin/news/edit?id=${news.id}" method="post" enctype="multipart/form-data">
	<div class="row">
						...
						<div class="col-md-12 mt-3">
						    ...
						    <div class="d-flex">
						        <div class="form-check">
						            <input class="form-check-input" type="radio" name="home" id="home1" value="true" ${news.home?'checked':''}/>
						            <label class="form-check-label" for="home1">Hiển thị</label>
						        </div>
						        <div class="form-check">
						            <input class="form-check-input" type="radio" name="home" id="home2" value="false"   ${!news.home?'checked':''}/>
